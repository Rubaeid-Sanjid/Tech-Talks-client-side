const Footer = () => {
  return (
    <div className="container mx-auto px-3 lg:px-12">
      <footer className="footer py-12 px-3 lg:px-0 text-base-content">
        <aside>
        ...
        <nav>
          <h6 className="footer-title text-lg text-black opacity-100">
            Company
          </h6>
        ...
        <nav>
          <h6 className="footer-title text-lg text-black opacity-100">Legal</h6>
          <a className="link link-hover">Privacy policy</a>
          <a className="link link-hover">Terms of Service</a>
          <a className="link link-hover">Extra Crunch Terms</a>
          <a className="link link-hover">Code of Conduct</a>
        </nav>
      </footer>
      <aside className="border-t-2 py-8 lg:w-1/2 mx-auto text-center">
        <p>Copyright © 2024 - All right reserved by TechTALKS Ltd</p>
      </aside>
    </div>
  );
};
